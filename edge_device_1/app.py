...
def model_predict(img_path):
    ...
    file_path = '/home/sagar/Main/SharedStorage/model/edge_model_1/model.json'
    ...
    # Create a numpy representation of the iage
...
def upl_new_data_to_fog(image,label):
    ...
    response = requests.post(url="http://0.0.0.0:9191/updateLocal")
    print("Triggered FOG node for local model update")
    os.remove(image)
    return "done"
