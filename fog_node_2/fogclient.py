...
def do_updateLocal():
    ...
    file_path = '/app/SharedStorage/model/fog_model_2/model.json'
    edge_path = '/app/SharedStorage/model/edge_model_2/model.json'
...
def do_getGobal():
    ...
    fog_node_path = '/app/SharedStorage/model/fog_model_2/model.json'
    edge_path = '/app/SharedStorage/model/edge_model_2/model.json'
